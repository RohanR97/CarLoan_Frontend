...
function AllEnquiry() {
  ...
  function postData(data) {
    axios.post("http://localhost:8081/createEnquiryAPI", data)
      .then(res => {
        if (res.status === 201) {
    ...
    <div className="container mt-5">
      ...
      <form onSubmit={handleSubmit(postData)}>
        <div className="form-group">
          ...
          <input type="text" className="form-control" {...register("firstName", { required: true })} placeholder="Enter your first name"/>
