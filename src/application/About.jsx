...
function About() {
  return (
    <div className="container mt-4">
      ...
      <ul>
        <li><strong>Rohan:</strong> Lead Backend Developer — architected our core business logic</li>
        <li><strong>Aarti:</strong> Frontend Developer — designed responsive UI with React</li>
        <li><strong>Kachan:</strong> QA Specialist — ensured system reliability and security</li>
        <li><strong>Komal:</strong> Coordinator — streamlined team efforts and timelines</li>
        <li><strong>Kartikeya:</strong> Integration Expert — enabled third-party services like CIBIL</li>
        <li><strong>Ashish:</strong> UX Designer — refined user experience across modules</li>
      </ul>
